<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Catalog.aspx.vb" Inherits="Catalog" %>
    ...
    <head runat="server">
        ...
        <title>Catalog — Pine Valley Furniture</title>
        <style>
        ...
        <form id="form1" runat="server">
            ...
            <nav class="navbar">
                ...
                <ul>
                    ...
                    <li><a href="DemandForecasting.aspx">Forecasting</a></li>
            ...
            <div class="content">
                ...
                <asp:TextBox ID="txtProductId" runat="server" Placeholder="Product ID" />
                <asp:TextBox ID="txtDescription" runat="server" placeholder="Product Description" />
                <asp:TextBox ID="txtPrice" runat="server" placeholder="Standard Price" />
                <asp:TextBox ID="txtFinish" runat="server" placeholder="Product Finish" />

                <asp:Button ID="btnAddProduct" runat="server" Text="Update Product" OnClick="btnUpdateProduct_Click" />
