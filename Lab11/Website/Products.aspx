<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Products.aspx.vb" Inherits="Products" Async="true" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="content">
                ...
                <div class="search-row">
                    ...
                    <asp:Button ID="btnShowReorder" runat="server" Text="Reorder Suggestions"
                        OnClick="btnShowReorder_Click" />
                </div>
                ...
                <asp:Panel ID="pnlReorder" runat="server" Visible="false"
                    CssClass="recommendations-container reorder-panel">
