<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserRegistration.aspx.vb" Inherits="Registration" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="content">
                ...
                <div class="section-divider">
                    ...
                    <asp:TextBox ID="txtUpdateName" runat="server" placeholder="Full Name" />
                    <asp:TextBox ID="txtUpdateAddress" runat="server" placeholder="Address" />
                    <asp:TextBox ID="txtUpdateCity" runat="server" placeholder="City" />
                    <asp:TextBox ID="txtUpdateState" runat="server" placeholder="State (e.g. NY)" MaxLength="2" />
                    <asp:TextBox ID="txtUpdatePostal" runat="server" placeholder="Postal Code" />
